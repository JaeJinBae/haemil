...
<body>
	...
	<section>
		...
		<div class="contentWrap">
			<div class="sideMenuWrap">
				...
				<div class="navWrap">
					<ul class="navUl"> 
						...
						<li>
							<a href="#none">상속<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
						...
						<li>
							<a href="#none">상속한정승인<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
							<ul class="sub_subDropdown">
								<li><a href="${pageContext.request.contextPath}/menu04_1">상속재산파산</a></li>
						<li><a href="${pageContext.request.contextPath}/menu04_2">상속한정승인</a></li>
							</ul>	
			...
			<div class="content">
				<img src="${pageContext.request.contextPath}/resources/images/menu04_2contentImg.jpg">
			</div>
		</div>
	</section>
	<footer>
