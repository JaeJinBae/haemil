...
<body>
	...
	<section>
		<div class="topImg">
			<img class="pcTopImg" src="${pageContext.request.contextPath}/resources/images/menu03TopImg.jpg">
			<img class="mTopImg" src="${pageContext.request.contextPath}/resources/images/mMenu03TopImg.jpg">
		</div>
		<div class="contentWrap">
			<div class="sideMenuWrap">
				...
				<div class="navWrap">
					<ul class="navUl"> 
						...
						<li>
							<a href="#none">간이파산<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
							<ul class="sub_subDropdown">
								<li><a href="${pageContext.request.contextPath}/menu03_1">법인회생</a></li>
								<li><a href="${pageContext.request.contextPath}/menu03_2">법인파산</a></li>
								<li><a href="${pageContext.request.contextPath}/menu03_3">간이회생</a></li>
			...
			<div class="content">
				<img src="${pageContext.request.contextPath}/resources/images/menu03_4contentImg.jpg">
			</div>
		</div>
	</section>
	<footer>
