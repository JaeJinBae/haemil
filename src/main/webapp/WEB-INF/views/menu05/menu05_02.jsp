...
<body>
	...
	<section>
		...
		<div class="contentWrap">
			<div class="sideMenuWrap">
				...
				<div class="navWrap">
					<ul class="navUl"> 
						...
						<li>
							<a href="#none">민사진행절차<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
							<ul class="sub_subDropdown">
								<li><a href="${pageContext.request.contextPath}/menu05_1">민사소송이란?</a></li>
						<li><a href="${pageContext.request.contextPath}/menu05_2">민사진행절차</a></li>
							</ul>	
			...
			<div class="content">
				<img src="${pageContext.request.contextPath}/resources/images/menu05_2contentImg.jpg">
			</div>
		</div>
	</section>
	<footer>
