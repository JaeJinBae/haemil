...
<body>
	...
	<section>
		...
		<div class="contentWrap">
			...
			<div class="content">
				<img class="pcContent" src="${pageContext.request.contextPath}/resources/images/menu01_2contentImg.jpg">
				<img class="tmContent" src="${pageContext.request.contextPath}/resources/images/tmMenu01_2contentImg.jpg">
			</div>
		</div>
	</section>
	<footer>
