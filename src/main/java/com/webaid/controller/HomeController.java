...
public class HomeController {
	...
	@RequestMapping(value = "/menu02_4", method = RequestMethod.GET)
	public String menu02_04(){
		logger.info("menu02_04");
		
		return "menu02/menu02_04";
	}
	...
	@RequestMapping(value = "/menu03_4", method = RequestMethod.GET)
	public String menu03_04(){
		logger.info("menu03_04");
		
		return "menu03/menu03_04";
	}
